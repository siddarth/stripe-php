...
3. Edit the files to fix the following: STRIPE_PUBLISHABLE_KEY,
STRIPE_API_KEY, and path-to-Stripe.php. Stripe's API keys can be obtained by
signing up for an account at stripe.com
